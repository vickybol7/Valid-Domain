            ...
            for field in all_fields:
                try:
                    ...
                    if any(k in label_text for k in ['name', 'full name', 'yourname', 'contact name']):
                        ...
                        value = "Automated Contact Inquiry"
...
def process_website(url):
    ...
    try:
        ...
        if contact_url:
            ...
            if not submitted:
                print("⚠️ Could not complete submission.")
        else:
...
message_text.insert("1.0", "Hello, I’m reaching out via your contact form. Please get back to me. Thanks!")
...
if not os.path.exists(file_path):
    print(f"❌ 'Dubai Website_Login_Detector.txt' not found. Add a file with one URL per line.")
    exit()
